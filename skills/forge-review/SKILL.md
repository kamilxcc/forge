...
本 skill 文件位于 `<plugin-root>/skills/forge-review/SKILL.md`，因此：
- plugin-root = 本文件向上**两级**目录
- 例：本文件路径为 `/Users/foo/forge-plugin/skills/forge-review/SKILL.md` → `<plugin-root>` = `/Users/foo/forge-plugin`
